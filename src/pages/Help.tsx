            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 pl-12 text-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-navy-400"
                />
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <h4 className="text-lg font-semibold text-gray-800 hover:text-navy-800">
                            {article.title}
                          </h4>
                          {article.popular && (
